...
const donationData = {
  BTC: '133NzbWr7hJwUyW3LGEqyv9bJEyekbP5uy',
  ETH: '0x49452d76e969183693219c20fe026Fbc3747E003',
}
  ...
  render () {
    return <div>
      {this.state.shownDonationCoin !== null ? <div className="Footer-donate-address">
        <h1>Thank you!</h1>
        <h2>{this.state.shownDonationCoin} Donation Address:</h2>
        <p>{donationData[this.state.shownDonationCoin]}</p>
      </div> : null}
